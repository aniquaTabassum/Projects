...
{
    int choise;
    printf("Enter 1 for Compression and 2 for decompression\n");
    scanf("%d",&choise);
    if(choise==1)
    compressionFunction();
    else
